...
const iDontKnowMyInventory = inventory[inventory.length-1];
console.log(iDontKnowMyInventory.car_make, iDontKnowMyInventory.car_model)


// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
const alphabetSoup = [];
for(tim=0; tim<inventory.length; tim++){
    alphabetSoup.push(inventory[tim].car_model)
}
console.log(alphabetSoup.sort())


// ==== Challenge 4 ====
// The accounting team needs all the years from every car on the lot. Create a new array from the dealer data containing only the car years and log the result in the console.
const yearsOfOurCars = [];
for (leon=0; leon<inventory.length; leon++){
    yearsOfOurCars.push(inventory[leon].car_year)
}
console.log(yearsOfOurCars.sort())
...
const preZCars = [];
for(loralie=0; loralie<inventory.length; loralie++){
    if(inventory[loralie].car_year < 2000){
        preZCars.push(inventory[loralie].car_year)
    };
}
console.log(preZCars.sort())
...
const BMWAndAudi = [];
for(mysti=0; mysti<inventory.length; mysti++){
    if(inventory[mysti].car_make === "BMW" || inventory[mysti].car_make === "Audi"){
        BMWAndAudi.push(inventory[mysti])
    }
}
...
//////////////////////////////////////////Previous Answers////////////////////////////////////////////
//1) console.log(`Car 33 is a ${inventory[32].car_year}, ${inventory[32].car_make}, ${inventory[32].car_model}`)

//2)let lastCar = inventory[inventory.length-1];
